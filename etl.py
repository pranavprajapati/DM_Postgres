...
def process_log_file(cur, filepath):
    ...
    """
    Insert records into time and user tables using data from log file.
    Also fill the songplay table with matching songs
...
def process_data(cur, conn, filepath, func):
    """
    Find the files from directories to process the data
